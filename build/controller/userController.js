...
var githubLogin = _passport["default"].authenticate("github"); // github 인증
...
var githubLoginCallback = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(accessToken, refreshToken, profile, cb) {
    var _profile$_json, id, name, email, avatar_url, user, newUser;

    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _profile$_json = profile._json, id = _profile$_json.id, name = _profile$_json.name, email = _profile$_json.email, avatar_url = _profile$_json.avatar_url;
            _context2.prev = 1;
            _context2.next = 4;
...
var postEditProfile = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(req, res) {
    var _req$body2, name, email, _req$user, id, avatarUrl, file;

    return regeneratorRuntime.wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            _req$body2 = req.body, name = _req$body2.name, email = _req$body2.email, _req$user = req.user, id = _req$user.id, avatarUrl = _req$user.avatarUrl, file = req.file;
            _context5.prev = 1;
            _context5.next = 4;
